...
module.exports = {
  purge: ["./components/**/*.{js,ts,jsx,tsx}", "./app/**/*.{ts,tsx}"], // PurgeCSS
  darkMode: 'class', // Dark mode
  theme: {
    extend: { // Using extend functionality
      fontFamily: {
      ...
      colors: {
        omneer: { // Use Omneer colors
          primary: '#001e42',  // deep blue color for the Omneer brand
          secondary: '#F5F5F5',  // off-white color for the Omneer brand
          background: "#000212",
          grey: "#858699",
          "grey-dark": "#222326",
          "primary-text": "#b4bcd0",
